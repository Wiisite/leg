          ...
          <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr_0.8fr_1fr] border-b border-white/15 pb-10">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-blue-100/85">
                ...
                <li><button onClick={() => (window.location.href = "/#sobre")}>Sobre nós</button></li>
                <li><button onClick={() => (window.location.href = "/#torneios")}>Notícias</button></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-blue-100/85">
                {modalitiesInOrder.map((mod) => (
                  <li key={mod}>
                    <button onClick={() => navigate(`/modalidade/${mod}`)}>{MODALITY_CONFIG[mod]?.label ?? mod}</button>
                  </li>
                ))}
              </ul>
            </div>
